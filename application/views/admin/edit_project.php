                ...
                <div class="col-lg-12"> 
                    <div class="col-md-6">
						<div class="form-group">
							...
							<input value="<?php echo $project['name']; ?>" name="project_name" required class="form-control">
						</div>
					</div>
					<input value="<?php echo $project['id']; ?>" type="hidden" name="pid" required class="form-control">
					<!--<div class="col-md-6">
						<div class="form-group">
							...
							<select name="category" required class="form-control">
								...
								<?php foreach($categories as $row){ ?> 
									<option <?php if($project['category_id'] == $row['id']){echo 'selected';} ?> value="<?php echo $row['id']; ?>"><?php echo ucfirst($row['name']);?></option> 
								<?php  }?>
							</select>
						</div>
					</div>-->
					<div class="col-md-6">
						<div class="form-group">
							...
							<input value="<?php echo $project['venue']; ?>" name="client" required class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Date<span class="text-danger">*</span></label>
							<input value="<?php echo date('d-M-Y', strtotime($project['date'])); ?>" name="location" required class="form-control">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Duration<span class="text-danger">*</span></label>
							<input value="<?php echo $project['duration']; ?>" name="duration" required class="form-control">
						</div>
					</div>
					<div class="col-md-12">
						<div class="form-group">
							<label>Description<span class="text-danger">*</span></label>
							<textarea class="ckeditor" name="description" class="form-control"> <?php echo $project['description']; ?></textarea>
						</div>
					</div> 
					<div class="col-md-12 form-group">
						<div class="">
							...
							<div id="feature-img-div"> 
								<div class="feature-img-block" style="display:none;">   
									<input id="feature-img" class="photoimgat" name="userfile[]" onchange="ShowPreview(this)" data="1" type="file">
								</div>
								<div class="block-thumb-feature"><a class="change-img" type="fimg" data="1"><img src="<?php echo  base_url('uploads/'.$project['image']); ?>" alt="" width="100%"></a></div>
							</div>    
						</div> 
					</div> 
					<div class="col-md-12">
